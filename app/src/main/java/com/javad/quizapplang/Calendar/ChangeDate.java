...
//    String time = curDate.getHour() + ":"+curDate.getMinute()+":"+curDate.getSecond();
  ...
  {
    Date miladiDate = com.javad.quizapplang.Calendar.ShamsiCalendar.shamsiToMiladi_persiancoders(farsiDate);
    SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd");
  ...
  {
    return com.javad.quizapplang.Calendar.ShamsiCalendar.miladiToShamsi_persiancoders_com(toDate(miladiDate));
  }


  public static String getDayMounthYear(){
    return com.javad.quizapplang.Calendar.ShamsiCalendar.weekDayName(com.javad.quizapplang.Calendar.ShamsiCalendar.dayOfWeek(ChangeDate.getCurrentDate()))+ " "+
           com.javad.quizapplang.Calendar.ShamsiCalendar.monthDayName(ChangeDate.getCurrentDay())+
           com.javad.quizapplang.Calendar.ShamsiCalendar.monthName(ChangeDate.getCurrentMonth()) +" ماه "  +
