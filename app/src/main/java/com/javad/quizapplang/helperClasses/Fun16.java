            ...
            for (int i = 0; i < listTxtViewgozine.size(); i++) {
                ...
                listTxtViewgozine.get(i).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        txtViewJakhaliEnableMokaleme.setBackgroundColor(Color.WHITE);
                        Log.e("whichTxtviewJakhali",listTxtviewmokaleme.get(listKolTxtViewMokaleme.get(listPosJakhali.get(positionEnableJakhali))).getTag().toString());
...
//                if (whichKhatHaveJakhali.size()==0){
//                    whichKhatHaveJakhali.add(i);
//                }else {
//                    whichKhatHaveJakhali.add(whichKhatHaveJakhali.size());
//                }
                whichKhatHaveJakhali.add(i);
