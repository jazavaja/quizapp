...
public class TooltipWindow {
    ...
    public TooltipWindow(Context ctx) {
        ...
        contentView = inflater.inflate(R.layout.tooltip_bottom, null);
    }

    public void showToolTip(View anchor,String content) {

        tipWindow.setHeight(ActionBar.LayoutParams.WRAP_CONTENT);
        tipWindow.setWidth(ActionBar.LayoutParams.WRAP_CONTENT);
        textView = contentView.findViewById(R.id.tooltip_text);
...
// send message to handler to dismiss tipWindow after X milliseconds
        handler.sendEmptyMessageDelayed(MSG_DISMISS_TOOLTIP, 50000);
    }
